...
export const nakathTimes: NakathTime[] = [
  {
    ...
    desc: {
      ...
      si: "ශුභ නොනාගත / පුණ්‍ය කාලය ආරම්භ වේ (ප.ව. 3:08 සිට ප.ව. 3:56 දක්වා). වැඩ නොකළ යුතු, ආහාර නොගත යුතු කාලයකි. ධාර්මික කටයුතුවල නියැළී, ගෙය සකසා නව වර්ෂය ලැබීමට සූදානම් වන්න.",
