...
export const nakathTimes: NakathTime[] = [
  ...
  },
  {
    ...
    desc: {
      en: "The most sacred moment — the Sinhala & Tamil New Year officially begins. Face South in Red attire. Light oil lamps, offer betel leaves, and welcome the new year with joy.",
      si: "වඩාත් ශුභ මොහොත — සිංහල හා දෙමළ අළුත් අවුරුද්ද ආරම්භ වේ. රතු ඇඳුම් ඇඳ දකුණු දෙසට හැරී ගිතෙල් පහන් දල්වා, බුලත් දල්ලක් පිළිගන්වා, සතුටින් නව වර්ෂය පිළිගන්න.",
      ta: "மிகவும் புனிதமான தருணம் — சிங்கள மற்றும் தமிழ் புத்தாண்டு தொடங்குகிறது. சிவப்பு ஆடை அணிந்து தெற்கு நோக்கி விளக்கேற்றி, வெற்றிலை படைத்து, மகிழ்ச்சியுடன் புத்தாண்டை வரவேற்கலாம்.",
    },
  },
  {
    id: "hearth",
